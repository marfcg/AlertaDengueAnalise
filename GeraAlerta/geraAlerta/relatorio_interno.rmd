...
g + geom_bar(stat="identity") + 
    ...
    theme_bw(base_size=11, base_family="Arial") +
    labs(y = "IPO", x="") +
    ggtitle("Índice de positividade de ovitrampas nos últimos 12 meses")
...
plot.alerta2<-function(d2=d2,ap){
  par(mai=c(0,0,0,0),mar=c(4,4,1,4))
  ...
  # Cria segundo eixo-y com incidencia
  par(new = T)
  norma = 100000/pop$Pop2010[pop$APS==ap]
  dv2.inc <- dv2.ts*norma
  # Define o limite superior, reduzindo em 4%
  # para compensar o espaço adicional do estilo do eixo:
  ymax.inc = par("usr")[4]*norma*.96
  plot(dv2.inc,axes=F,ylim=c(0,ymax.inc),xlab=NA,ylab=NA)
  axis(4, ylim=c(0,ymax.inc))
  mtext(side=4, line=3, "Incidência (1:100000)")
  }
```
